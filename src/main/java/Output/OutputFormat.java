...
public class OutputFormat {
    ...
    public String outputToClipboard(MathObject startNode) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, err.getClass().getName() + ": " + err.getLocalizedMessage() + " : " + langMan.readLangFile("ReadingFile"), "DragMath444", JOptionPane.ERROR_MESSAGE);
        }
        return syntax;
    }
...
//            JOptionPane.showMessageDialog(null, appletCodeBase, "DragMath444", JOptionPane.INFORMATION_MESSAGE);

            formatDoc = builder.build(path);
            outputFormat = fileName;
        } catch (java.io.FileNotFoundException ex) {
            JOptionPane.showMessageDialog(null, ex.getClass().getName() + ": " + ex.getLocalizedMessage() + " : " + langMan.readLangFile("ReadingFile2") + " " + fileName, "DragMath444", JOptionPane.ERROR_MESSAGE);
        } catch (JDOMException ex) {
            JOptionPane.showMessageDialog(null, ex.getClass().getName() + ": " + ex.getLocalizedMessage() + " : " + langMan.readLangFile("ReadingFile2") + " " + fileName, "DragMath444", JOptionPane.ERROR_MESSAGE);
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, ex.getClass().getName() + ": readFormatFile: " + ex.getLocalizedMessage() + " : " + langMan.readLangFile("ReadingFile2") + " " + fileName, "DragMath444", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public void readMathTranFile() {
        try {
            ...
            JOptionPane.showMessageDialog(null, ex.getClass().getName() + ": " + ex.getLocalizedMessage() + " : " + langMan.readLangFile("ReadingFile2") + "MathTran", "DragMath444", JOptionPane.ERROR_MESSAGE);
        } catch (JDOMException ex) {
            JOptionPane.showMessageDialog(null, ex.getClass().getName() + ": " + ex.getLocalizedMessage() + " : " + langMan.readLangFile("ReadingFile2") + "MathTran", "DragMath444", JOptionPane.ERROR_MESSAGE);
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, ex.getClass().getName() + ": readMathTranFile " + ex.getLocalizedMessage() + " : " + langMan.readLangFile("ReadingFile2") + "MathTran", "DragMath444", JOptionPane.ERROR_MESSAGE);
        }
    }
